# Renders sync_fifo_waveform.svg (the README sync-FIFO waveform) from sync_wave.csv
...
for i, (name, vals) in enumerate(bits):
    ...
    ax.text(a - 0.9, base + lane_h / 2, name, ha='center', va='center',
...
plt.tight_layout()
plt.savefig('sync_fifo_waveform.svg', bbox_inches='tight', facecolor='white')
print('wrote sync_fifo_waveform.svg; rows', N)
